...
public interface ProductoDao extends JpaRepository<Producto, Long> {
  ...
  /**
   * Vamos a necesitar tres métodos adicionales a los que genera el crud
   * repository
   * (interface), para
   * 1.Recuperar lista de productos ordenados
   * 2.Recuperar litado de productos paginados, que no traiga todos los productos
   * sino de 10 en 10 o en 20 etc.
   * 3. Consulta para recuperar los productos o las presentaciones con sus
   * productos correspondientes
   * sin tener que realizar una subconsulta que sería menos eficiente que un join
   * a las entidades
   * utilizando HQL (Hibernate Query Language)
   */
   ...
   * recuperar no todos los productos, sino por pagina, es decir, de 10 en 10, de
   * 20
   * en 20, etc.
   * 
   ...
   * por algun criterio de ordenación, como por ejemplo por el nombre del
   * producto,
   * por la descripcion, etc.
   */

  // Elegir el sort de domain
  @Query(value = "select p from Producto p left join fetch p.presentacion") // esto es HQL
  ...
  /**
   * El siguiente método recupera un producto por el id
   */
